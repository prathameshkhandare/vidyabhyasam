...
const initiatives = [
  ...
  {
    title: 'Values',
    description: 'VIDYABHYASAM is proud to say that women from rural areas are coming forward to take the training to be teachers and in turn, motivate children to achieve woman empowerment and childrens education.',
    image: valuesImg,
      ...
      <div className="relative max-w-7xl mx-auto px-6 lg:px-8">
        ...
        <div className="text-center mb-20">
          ...
          <h2 className="font-serif text-4xl md:text-5xl font-medium text-[#2E2E33] mb-6">
            Core <span className="italic text-[#2F3A8F]">Initiatives</span>
          </h2>
